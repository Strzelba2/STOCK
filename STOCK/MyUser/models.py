...
def path_file_name(instance, filename):
    return '{username}{random}.jpg'.format(
...
class MyUsers(AbstractBaseUser, PermissionsMixin):
    ...
    facebook_user_id = models.CharField(max_length=300, blank=True, null=True)
    facebook_picture = models.CharField(max_length=300, blank=True, null=True)
    google_user_id = models.CharField(max_length=300, blank=True, null=True)
    google_picture = models.CharField(max_length=300, blank=True, null=True)
