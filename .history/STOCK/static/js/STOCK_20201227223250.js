    ...
    function zoomend() {
        if (zoom_off === false) {
            ...
            resizeTimer = setTimeout(function() {
                    ...
                    buffer = ((maxP - minP) * 0.8).toFixed(1 console.log(minP) console.log(maxP) console.log((maxP - minP) * 0.8) console.log(buffer) yScale.domain([minP - buffer, maxP + buffer]) console.log(yScale.domain()) candles.transition()
                        .duration(2)
