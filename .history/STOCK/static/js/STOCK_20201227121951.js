...
function chart_zoom(range_data, selection) {
    ...
    var margin = { top: 40, right: 30, bottom: 30, left: 30 },
        width = range_data[1] * 5 - margin.left - margin.right,
...
var width_focus = 1100,
    ...
    mvar xScale_focus = d3.scaleLinear().domain([-1, sort_Data.length])
    .range([0, width_focus])
...
var gX_focus = focus_chart.append("g")
    ...
    .attr("transform", `translate(0,${height_focus - margin.bottom})`)
    .style("fill", "#E5E5E5")
    .call(xAxis_focus)
