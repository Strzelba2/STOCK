...
function chart_zoom(range_data, selection) {
    ...
    var lineButton = d3.select("#chart")
        .append("div")
        ...
        .text("linia")
        .on('click', drop)
    var content = lineButton.append("div")
        .attr("class", "dropdown-content")
        .attr("id", "myDropdow")

    var button_line = content.append("button")
        .attr('width', 20)
        .attr('height', 20)
        .attr("type", "button")
        .attr("class", "btn-cont")
        .text("linia")
        .on('click', createDot)
    var button_horizontal = content.append("button")
        .attr('width', 20)
        .attr('height', 20)
        .attr("type", "button")
        .attr("class", "btn-cont")
    ...
    function drop() {
        d3.selectAll(".dropdown-content").attr("class", "sow")
