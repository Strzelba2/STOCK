...
function chart_zoom(range_data, selection) {
    ...
    function lineHorizontal() {
        ...
        zoom_off = true
        console.log(points[0].name.substr(0, 5))
        for (i in points) {
            console.log(i.name.substr(0, 5))

        }
        var length_class = _.filter(points, i => (i.name.substr(0, 5) === "LineH"))
        console.log(length_class)
        var name = "LineH" + (length_class.length + 1)
