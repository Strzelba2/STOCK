    ...
    function zoomed() {
        if (zoom_off === false) {
            ...
            var Circle_zoom = chart.selectAll("'circle')
                ...
                .attr("width", xBand.bandwidth() * t.k); stems.attr("x1", (data, i) => xScaleZ(i) - xBand.bandwidth() / 2 + xBand.bandwidth() * 0.5); stems.attr("x2", (data, i) => xScaleZ(i) - xBand.bandwidth() / 2 + xBand.bandwidth() * 0.5);
